/**
 * SHA-256 (FIPS 180-4) in plain TypeScript, so the package stays free of Node built-ins
 * and runs unchanged in the console. Tests compare it with node:crypto.
 */
...
/** SHA-256 digest of `bytes` as 64 lowercase hex digits. */
